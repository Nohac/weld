...
This directory contains the published source of the Bevy 0.19.0 crates whose
...
The sources come from Bevy tag `v0.19.0`. The narrow compatibility changes are
